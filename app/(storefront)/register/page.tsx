      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden bg-zinc-900 text-white">
        ...
        <div className="relative z-10 space-y-4 max-w-md">
          ...
          <h2 className="font-serif text-3xl xl:text-4xl font-light italic leading-tight">
            &ldquo;Join a circle dedicated to enduring style, thoughtful design, and effortless wardrobe curation.&rdquo;
          </h2>
          <div className="space-y-1.5 text-xs text-zinc-300 pt-2">
            <p className="flex items-center gap-2">✓ Early access to limited seasonal lookbook drops</p>
            <p className="flex items-center gap-2">✓ Priority 48-hour delivery across Bangladesh</p>
            <p className="flex items-center gap-2">✓ Personalized wardrobe &amp; sizing recommendations</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-8">
          <div>
            ...
            <p className="mt-1 text-xs sm:text-sm text-muted-foreground">
              Shop faster, save personal favorites to your wishlist, and track live deliveries.
            </p>
          </div>
